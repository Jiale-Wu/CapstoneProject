...
import com.example.capstoneproject.databinding.FragmentAccountDetailsBinding;
...
public class AccountDetails extends Fragment {
    ...
    AccDetailListener mListener;

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        mListener = (AccDetailListener) context;
    }

    interface AccDetailListener {
        void back();
    }
}