...
import com.example.capstoneproject.databinding.FragmentAdvancedSettingsBinding;
...
public class AdvancedSettings extends Fragment {
    ...
    FragmentAdvancedSettingsBinding binding;
    ...
    AdvancedSettingsListener mListener;
    ...
    interface AdvancedSettingsListener {
        void back();
    }
}